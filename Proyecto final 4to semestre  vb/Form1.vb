...
Public Class Form1
    ...
    Private Sub InitializeDatabaseConnection()
        Dim connectionString As String = "Server=DESKTOP-O58ILA\SQLEXPRESS;Database=Restaurante;Integrated Security=True;"
        sqlConnection = New SqlConnection(connectionString)
    End Sub
    Private Sub SaveDataToDatabase()
        Try
            sqlConnection.Open()
            Dim sqlDataAdapter As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Comida", sqlConnection)
